...
<html lang="en">
   <head>
      ...
      $favicon=$config['favicon']
                  ?>
      <link rel="icon" href="<?php echo $config['url'];?>" type="image/jpg">
      <title>Sunny | Onepage Multipurpose Website</title>
				...
				<div class="row">
					<div class="col-md-6 col-sm-12">
                     ...
                     if($config['header_email']){
                        ?>
                        <a href="mailt:"><i class="fa fa-envelope"></i><?php echo $config['header_email']; ?></a>
                     <?php
                     }
                     ?>
                     ...
                     if($config['header_phone']){
                        ?>
                        <a href="tel:"><i class="fa fa-phone"></i><?php echo $config['header_phone']; ?></a>
                     <?php
                     }
                     ?>
