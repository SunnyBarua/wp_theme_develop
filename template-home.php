...
?>
      ...
      <section class="about-area pt-100 pb-100" id="about">
         <div class="container">
         <?php $config=get_option('sunny_options');
         if($config['about_sec_title']){
            ...
            <div class="col-md-6">
               <p><?php echo $config['about_sec_title'];?></p>
            </div>
         </div>
         <?php 
         }
            ...
            <div class="row">
               ...
               <div class="col-md-5">
                  ...
                  foreach($about_features as $about_feature){
                     ...
                     <p><?php echo $about_feature["features_desc"] ?></p>
                  </div>
                  <?php
                  }
                     ...
                     foreach($about_accordions as $about_accordion){
                        ...
                        <div class="card">
                           ...
                           <div id="collapse-<?php echo $i;?>" class="collapse <?php if($i==1){echo 'show';} ?>" aria-labelledby="heading<?php echo $i;?>" data-parent="#accordionExample">
                              <div class="card-body">
                              <?php echo $about_accordion['faq_desc']; ?>
                              </div>
                           </div>
                        </div>
                        <?php
                  ...
                  <div class="skills">
                     ...
                     if($about_skills){
                        foreach ($about_skills as $about_skill){
                           ...
                           <div class="progress-bar" role="progressbar" style="width: <?php echo $about_skill['skill_numb']; ?>%;" aria-valuenow="<?php echo $about_skill['skill_numb']; ?>" aria-valuemin="0" aria-valuemax="100"><?php echo $about_skill['skill_numb']; ?></div>
                        </div>
                        <?php
                        }
                     } 
         ...
         <div class="container-fluid">
            ...
            foreach($counters as $counter) {
               ...
               <div class="single-counter">
                  <h4><i class="<?php echo $counter['counter_icon'];?>"></i><span class="counter"><?php echo $counter['counter_numb'];?></span><?php echo $counter['counter_title'];?></span></h4>
               </div>
            </div>
            <?php
            }}
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               while($query->have_posts()){
                  ...
                  $team_instagram=get_field('team_instagram');
                           ...
                           <ul>
                              <?php 
                               if($team_facebook){
                                  ?>
                                 <li>
                                 <a href="<?php echo $team_facebook;?>"><i class="fa fa-facebook"></i></a></li>
...
<?php 
                              ...
                              <?php 
                               if($team_instagram){
                                 ...
                                 <li><a href="<?php echo $team_instagram;?>"><i class="fa fa-instagram"></i></a></li>
               ...
               <div class="col-md-12">
                  <div class="testimonials owl-carousel">
                    ...
                    while($query->have_posts()){
                       ...
                       <h4><?php $name; ?> <span><?php $designation; ?></span></h4>
                    </div>
                    <?php 
                    };
                    wp_reset_postdata();
